...
<body>
    ...
    <div class="full-page">
      ...
      <div class="text">
        ...
        <div class="text">
          <input type="text" id="drno" name="drno" placeholder="Customer Id" required/>
        </div>
        <div class="text">
...
if sub!=None:
    ...
    q = """select * from customer where fullname='%s'and coustid='%s' and password='%s'""" %(name,rno,password)
    cur.execute(q)
    ...
    if r != None:
        ...
        location.href="home_admin.py?rno=%s";
        </script>
        """%(rno))
    else:
        print("""
